            ...
            <div className="p-1">
              <Card className="">
                <CardContent className="flex flex-col aspect-square p-6">
                    ...
                    <h3 className="font-bold text-xl mb-1">Brushura</h3>
                    <p>Absolutely amazing. Team did everything I asked for and did exactly what I asked for and I’m amazed how good they did it. Website development is extremely hard and having someone so reliable like Markloops team is necessity. I will hire them for any future project and will recommend them to everyone! Thank you so much.</p>
            ...
            <div className="p-1">
              <Card className="">
                <CardContent className="flex flex-col aspect-square p-6">
                    ...
                    <h3 className="font-bold text-xl mb-1">Audette</h3>
                    <p>I recently had the pleasure of using Naseers's services, and I must say, I was thoroughly impressed! Their team's professionalism, expertise, and dedication to delivering top-notch results exceeded my expectations.</p>
                    <div className="flex align-start justify-end">
                        <svg className="w-16 h-16 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V8a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1Zm0 0v2a4 4 0 0 1-4 4H5m14-6V8a1 1 0 0 0-1-1h-3a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1Zm0 0v2a4 4 0 0 1-4 4h-1"/>
                        </svg>
