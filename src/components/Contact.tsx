            ...
            <div className="flex align-items justify-center ">
                <div className="md:w-2/6 sm:w-2/3 w-full sm:px-0 px-2">
                    <div className="flex flex-col">
                        <Input placeholder="Full Name" className="2xl:text-xl mb-3"/>
                        <Input placeholder="Email" className="2xl:text-xl mb-3"/>
                        <Input placeholder="Phone Number" className="2xl:text-xl mb-3"/>
                        <Textarea placeholder="Message" className="2xl:text-xl mb-3"/>
                        <div className="w-full flex align-items justify-center mt-3">
                        <button className="btn-dark 2xl:text-2xl w-4/5 sm:w-3/5 md:w-3/5 lg:w-2/5 flex justify-center gap-x-2">
