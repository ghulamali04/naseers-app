...
const Comparison: React.FC = () => {
    return (
        <section className="bg-white pt-11 pb-16 sm:px-10">
            <h2 className="text-primary 2xl:text-6xl text-3xl sm:text-5xl font-bold w-full text-center mb-9 mt-5">Goodbye To Traditional Website</h2>
                        ...
                        <Card className="bg-primary">
                            <CardContent className="flex flex-col justify-center p-6 min-h-72">
                                <div className="bg-white p-4 rounded-full w-fit mb-5">
                                    <svg className="w-6 h-6 2xl:w-8 2xl:h-8 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <h3 className="text-white text-xl 2xl:text-3xl mb-3">Save Time</h3>
                    ...
                    <div className="basis-full md:basis-2/3 lg:basis-2/3">
                        <Card className="bg-primary">
                            <CardContent className="flex flex-col justify-center p-6 min-h-72">
                                ...
                                <h3 className="text-white text-xl 2xl:text-3xl mb-3">Dedicated Support</h3>
                                <p className="text-white text-sm 2xl:text-xl">
                    ...
                    <div className="basis-full md:basis-2/3 lg:basis-2/3">
                        <Card className="bg-primary">
                            <CardContent className="flex flex-col justify-center p-6 min-h-72">
                                ...
                                <h3 className="text-white text-xl 2xl:text-3xl mb-3">Grow Your Business</h3>
                                <p className="text-white text-sm 2xl:text-xl">
