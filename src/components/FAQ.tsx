...
const FAQ: React.FC = () => {
    return (
        <section className="bg-white pt-11 pb-16 w-full sm:px-10">
             <h2 className="text-primary 2xl:text-6xl text-3xl sm:text-5xl font-bold w-full text-center mb-9 mt-5">Still Not Convinced?<br></br>We’ve Got The Answers</h2>
             <Accordion className="sm:px-0 px-2" type="single" collapsible>
                <AccordionItem value="item-1">
                    <AccordionTrigger className="text-2xl 2xl:text-3xl font-bold">What services are available at Naseers?</AccordionTrigger>
                    <AccordionContent className="sm:text-start 2xl:text-xl text-center sm:px-0 px-2">
                ...
                <AccordionItem value="item-2">
                    <AccordionTrigger className="text-2xl 2xl:text-3xl font-bold">How can Naseers help grow my business online?</AccordionTrigger>
                    <AccordionContent className="sm:text-start 2xl:text-xl text-center sm:px-0 px-2">
                ...
                <AccordionItem value="item-3">
                    <AccordionTrigger className="text-2xl 2xl:text-3xl font-bold">What happens once the project is done?</AccordionTrigger>
                    <AccordionContent className="sm:text-start 2xl:text-xl text-center sm:px-0 px-2">
                ...
                <AccordionItem value="item-4">
                    <AccordionTrigger className="text-2xl 2xl:text-3xl font-bold">How long will it take for an average project to be completed?</AccordionTrigger>
                    <AccordionContent className="sm:text-start 2xl:text-xl text-center sm:px-0 px-2">
                ...
                <AccordionItem value="item-5">
                    <AccordionTrigger className="text-2xl 2xl:text-3xl font-bold">How can I get sign up or register with Naseers?</AccordionTrigger>
                    <AccordionContent className="sm:text-start 2xl:text-xl text-center sm:px-0 px-2">
