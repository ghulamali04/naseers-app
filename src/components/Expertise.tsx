    ...
    return (
        <section id="expertise" className="bg-white pt-11 pb-16 w-full sm:px-10">
            ...
            <div className="flex items-center justify-center flex-wrap gap-x-7">
                ...
                <div className="flex flex-col items-center content-center">
                    <div className="rounded-full group hover:bg-primary cursor-pointer border border-black p-4">
                    <svg className="w-14 h-14 2xl:w-20 group-hover:text-white 2xl:h-20 text-gray-800 dark:text-white"
                ...
                <div className="flex flex-col items-center content-center">
                    <div className="rounded-full group hover:bg-primary cursor-pointer border border-black p-4">
                    <svg  className="w-14 h-14 2xl:w-20 2xl:h-20 group-hover:text-white text-gray-800 dark:text-white"
                ...
                <div className="flex flex-col items-center content-center">
                    <div className="rounded-full border group hover:bg-primary cursor-pointer border-black p-4">
                    <svg  className="w-14 h-14 2xl:w-20 2xl:h-20 group-hover:text-white text-gray-800 dark:text-white"
