...
const Expertise: React.FC = () => {
    return (
        <section className="bg-white pt-9 w-full pb-10 px-10">
             <h2 className="text-primary text-5xl font-bold w-full text-center mt-9 mb-3">We Are Expert In</h2>
            <div className="flex items-center justify-center pt-4 gap-x-7">
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Figma</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Shopify</span>
                </div>

                <div className="flex flex-col items-center content-center">
                    <div className="rounded-full border border-black p-4">
                    <svg className="w-14 h-14 text-gray-800 dark:text-white"
                    ...
                    <span className="text-primary text-md mt-2">Photoshop</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Illustrator</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Meta</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Laravel</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">React</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Google</span>
                </div>
                ...
                <div className="flex flex-col items-center content-center">
                    ...
                    <span className="text-primary text-md mt-2">Instagram</span>
                </div>
